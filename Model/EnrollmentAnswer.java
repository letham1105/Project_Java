...
public class EnrollmentAnswer {
    ...
    public String toString(){
        return "EnrollmentAnswer{"+"enrollment_answer_id="+enrollment_answer_id+",enrollment_id="+enrollment_id+",question_id="+question_id+",question_answer_id="+question_answer_id+'}';
    }
}
